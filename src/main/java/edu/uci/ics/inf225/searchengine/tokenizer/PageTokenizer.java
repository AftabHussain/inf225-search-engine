...
public class PageTokenizer {
	...
	public PageTokenStream tokenize(WebPage page, PageToken pageToken) throws IOException {
		return createPageTokenStream(page, pageToken);
	}

	private PageTokenStream createPageTokenStream(WebPage page, PageToken pageToken) throws IOException {
		return new PageTokenStream(analyzer, page, pageToken);
	}
